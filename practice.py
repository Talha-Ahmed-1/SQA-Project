...
# a = MySQLdb.connect(host = "localhost", user = "root", password = "test123", database = "Banquet")
from tkinter import *
...
class Staff:
    def __init__(self):
        self.db = MySQLdb.connect(host = "localhost", user = "root", password = "test123", database = "Banquet")
    ...
    def search_c(self):
        ...
        if counter == 0:
            db = MySQLdb.connect(host = "localhost", user = "root", password = "test123", database = "Banquet")
            cursor = db.cursor()
